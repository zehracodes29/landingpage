      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div id="pricing" className="scroll-mt-24 max-w-5xl mx-auto">
          ...
          <div className="text-center mb-0">
            <span className="inline-block bg-brand-surface-sm text-brand text-xs font-bold uppercase tracking-wider px-4 py-1.5 rounded-full mb-1.5">
              STEP 1 &bull; ONE-TIME SETUP
            </span>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-text-primary dark:text-white mb-1 text-center">
              Setup Cost
            </h2>
            <p className="text-xs sm:text-sm text-text-muted dark:text-slate-400 mb-4 sm:mb-6 text-center">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-5 flex flex-col gap-2.5">
                <div className="flex items-center gap-4 p-2.5 sm:p-3 rounded-2xl bg-white dark:bg-slate-800/80 border border-slate-200/60 dark:border-slate-700/60 shadow-sm">
                  <div className="w-8 h-8 bg-brand-surface-sm rounded-full flex items-center justify-center shrink-0">
              ...
              <div className="lg:col-span-7 bg-white dark:bg-slate-900 border-2 border-brand-border rounded-3xl p-4 sm:p-5 shadow-xl relative overflow-hidden">
                <div className="absolute top-0 right-0 bg-brand text-white text-[10px] font-extrabold tracking-widest uppercase px-8 py-1 rotate-45 translate-x-6 translate-y-3 shadow-md">
                  BEST VALUE
                </div>
                
                <span className="inline-block bg-brand-surface-sm text-brand text-[11px] font-bold tracking-wider uppercase px-3 py-1 rounded-full mb-2">
                  ONE-TIME PAYMENT
                </span>
                <div className="text-3xl sm:text-4xl font-black text-brand my-1">₹5,000</div>
                ...
                <a 
                  ...
                  className="w-full mt-4 bg-brand hover:bg-brand-hover text-white font-bold py-2.5 text-sm rounded-2xl shadow-md transition-all active:scale-95 block text-center"
                >
            ...
            {/* Bottom Skip Link */}
            <div className="mt-3 pt-2 border-t border-slate-200/60 dark:border-slate-800/60 text-center text-xs text-text-muted dark:text-slate-400">
              Don't want to pay this much?{' '}
              <a 
                href="#step-2-pricing" 
                className="text-brand font-bold underline underline-offset-4 hover:text-brand dark:hover:text-brand transition-colors"
              >
                Do it yourself →
              </a>
            </div>
          ...
          <div className="relative mt-16 sm:mt-20 mb-8 flex items-center justify-center max-w-4xl mx-auto">
            ...
            <div className="relative bg-[#FAF9F7] dark:bg-slate-950 px-6 text-sm font-bold text-text-secondary uppercase tracking-widest flex items-center gap-2">
          ...
          <div id="step-2-pricing" className="pt-8 sm:pt-12 scroll-mt-20 text-center mb-6">
            <span className="inline-block bg-brand-surface-sm text-brand text-[11px] font-bold uppercase tracking-wider px-3 py-1 rounded-full mb-1">
              STEP 2: MONTHLY HOSTING
            </span>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-text-primary dark:text-white mb-1">
              Choose Your Monthly Plan
            </h2>
            <p className="text-xs sm:text-sm text-text-muted dark:text-slate-400 max-w-xl mx-auto text-center mb-4 sm:mb-6">
          ...
          <div className="max-w-4xl mx-auto p-4 sm:p-6 bg-brand rounded-3xl shadow-2xl border border-purple-900/50 text-white relative">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
              ...
              <motion.div 
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="bg-white text-text-primary rounded-3xl p-4 sm:p-5 shadow-md flex flex-col justify-between border border-border-neutral"
              >
                <div>
                  <div className="w-10 h-10 sm:w-11 sm:h-11 bg-brand-surface-sm rounded-full flex items-center justify-center text-brand mb-2">
                ...
                <a 
                  href="#complete-website-setup"
                  className="w-full mt-4 border-2 border-brand text-brand font-bold py-2.5 text-sm rounded-2xl hover:bg-brand-surface-xs transition-all active:scale-95 block text-center"
                >
                  Get started
                </a>
              </motion.div>
              ...
              <motion.div 
                ...
                className="bg-white text-text-primary rounded-3xl p-4 sm:p-5 shadow-xl flex flex-col justify-between relative border-2 border-brand"
              >
                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-brand text-white text-[10px] font-extrabold tracking-widest uppercase px-4 py-1 rounded-full shadow-md">
                  MOST POPULAR
                </div>
