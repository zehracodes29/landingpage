      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div id="pricing" className="scroll-mt-24 max-w-5xl mx-auto">
          ...
          <div className="text-center mb-0">
            <span className="inline-block bg-purple-100 dark:bg-purple-950/60 text-purple-700 dark:text-purple-300 text-xs font-bold uppercase tracking-wider px-4 py-1.5 rounded-full mb-1.5">
              STEP 1 &bull; ONE-TIME SETUP
            </span>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white mb-1 text-center">
              Setup Cost
            </h2>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 mb-4 sm:mb-6 text-center">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 bg-white dark:bg-slate-900 border-2 border-purple-200 dark:border-purple-900/50 rounded-3xl p-4 sm:p-5 shadow-xl relative overflow-hidden">
                ...
                <div className="text-3xl sm:text-4xl font-black text-purple-700 dark:text-purple-400 my-1">₹5,000</div>

                <ul className="space-y-1.5 mt-4 mb-4">
                  {setupFeatures.map((feature, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <Check className="w-4 h-4 text-purple-600 shrink-0 mt-0.5" strokeWidth={2.5} />
            ...
            {/* Bottom Skip Link */}
            <div className="mt-3 pt-2 border-t border-slate-200/60 dark:border-slate-800/60 text-center text-xs text-slate-600 dark:text-slate-400">
          ...
          <div id="step-2-pricing" className="pt-8 sm:pt-12 scroll-mt-20 text-center mb-6">
            ...
            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 max-w-xl mx-auto text-center mb-4 sm:mb-6">
          ...
          <div className="max-w-4xl mx-auto p-4 sm:p-6 bg-indigo-950/90 dark:bg-purple-950/80 rounded-3xl shadow-2xl border border-purple-900/50 text-white relative">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
              ...
              <motion.div 
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="bg-white text-slate-900 rounded-3xl p-4 sm:p-5 shadow-md flex flex-col justify-between"
              >
                <div>
                  <div className="w-10 h-10 sm:w-11 sm:h-11 bg-purple-100 rounded-full flex items-center justify-center text-purple-600 mb-2">
              ...
              <motion.div 
                ...
                className="bg-white text-slate-900 rounded-3xl p-4 sm:p-5 shadow-xl flex flex-col justify-between relative"
              >
