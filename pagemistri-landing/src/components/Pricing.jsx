      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div id="pricing" className="scroll-mt-24 max-w-5xl mx-auto">
          ...
          <div className="text-center mb-10">
            <span className="text-xs font-semibold tracking-widest text-purple-600 uppercase mb-2 block">
              PRICING
            </span>
          ...
          {/* 2. First Level: Monthly Subscription Cards */}
          ...
          {/* 3. Middle Section Divider ("OR") */}
          <div className="relative my-12 flex items-center justify-center max-w-4xl mx-auto">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-slate-300 dark:border-slate-800" />
            </div>
            <div className="relative bg-[#FAF9F7] dark:bg-slate-950 px-6 text-sm font-bold text-slate-500 uppercase tracking-widest">
              OR
            </div>
          </div>

          {/* 4. Second Level: One-Time Setup Cost Banner Card */}
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8 rounded-3xl bg-purple-50/50 dark:bg-slate-900/50 border border-purple-100 dark:border-slate-800 max-w-4xl mx-auto"
          >
