...
const Hero = () => {
 return (
 <section className="bg-gradient-to-b from-purple-50/60 via-white to-slate-50 relative py-16 md:py-24 lg:py-32 w-full px-4 sm:px-6 lg:px-8 font-sans min-h-[90vh] flex flex-col justify-center">
 ...
 <div className="container mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
 ...
 >
 <div className="inline-flex justify-center sm:justify-start mb-6">
 ...
 <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto sm:mx-0 mb-8 leading-relaxed">
 ...
 <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-4 w-full sm:w-auto">
 <button 
 ...
 <div className="w-full max-w-full lg:max-w-none min-h-[320px] rounded-2xl border border-slate-200 shadow-2xl bg-white overflow-hidden relative">
 {/* Browser Header Bar */}
