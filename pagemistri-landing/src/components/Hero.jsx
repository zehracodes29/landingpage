...
const Hero = () => {
 return (
 <section className="bg-gradient-to-b from-purple-50/60 via-white to-slate-50 relative py-16 md:py-24 lg:py-32 w-full font-sans min-h-[90vh] flex flex-col justify-center">
 ...
 className="px-6 py-3 bg-purple-600 text-white font-semibold text-sm rounded-xl hover:bg-purple-700 hover:shadow-lg transition-all duration-300 w-full sm:w-auto border-none"
 >
