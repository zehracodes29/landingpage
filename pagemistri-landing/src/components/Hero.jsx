...
const Hero = () => {
 return (
 <section className="bg-gradient-to-b from-purple-50/60 dark:from-slate-900 via-white dark:via-slate-950 to-slate-50 dark:to-slate-950 relative pt-24 lg:pt-32 pb-12 lg:pb-16 w-full font-sans min-h-[90vh] flex flex-col justify-center">
