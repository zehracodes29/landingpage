...
export function AboutPagemistri() {
  return (
    <section id="about-pagemistri" className="scroll-mt-20 relative w-full overflow-hidden bg-gradient-to-tr from-[#5841D8]/5 via-white to-white dark:from-[#5841D8]/10 dark:via-slate-950 dark:to-slate-950 py-16 sm:py-20 lg:py-32">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          {/* Left Column - Content */}
          <div className="lg:col-span-5 space-y-8 z-10">
            <div className="inline-block px-4 py-1.5 rounded-full text-xs font-bold tracking-wider text-[#5841D8] bg-[#5841D8]/10 uppercase">
              ABOUT PAGEMISTRI
            </div>

            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black font-sans text-slate-900 dark:text-white tracking-tight">
              What is <span className="text-[#5841D8]">Pagemistri?</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <a
                href="#how-it-works"
                className="bg-white hover:bg-gray-50 text-slate-900 border border-gray-200 hover:border-[#5841D8] dark:bg-slate-900 dark:hover:bg-slate-800 dark:text-white dark:border-slate-800 dark:hover:border-[#5841D8] rounded-xl px-8 py-4 text-base font-bold group flex items-center justify-center transition-all"
              >
                <PlayCircle className="w-5 h-5 mr-2 text-slate-500 dark:text-slate-400 group-hover:text-[#5841D8] transition-colors" />
                See How It Works
              </a>
            </div>
          </div>
...
export function WhatIsPagemistriShowcase() {
  return (
    <div className="w-full relative flex flex-col items-center">
      ...
      >
        <div className="shadow-xl shadow-[#5841D8]/10 border border-[#5841D8]/20 dark:border-[#5841D8]/20 rounded-xl overflow-hidden bg-white dark:bg-slate-900">
      ...
      <div className="w-full grid grid-cols-3 gap-4 mt-2 relative">
        ...
        <div className="flex flex-col items-center relative">
          ...
          <motion.div
            ...
            className="w-full shadow-2xl shadow-[#5841D8]/10 rounded-xl overflow-hidden border border-[#5841D8]/20 bg-white origin-top dark:bg-slate-900 dark:border-[#5841D8]/20"
          >
            <img
