      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 space-y-8 z-10">
            <div className="inline-block px-4 py-1.5 rounded-full text-xs font-bold tracking-wider text-[#4400AF] bg-brand-surface-md uppercase">
              ABOUT PAGEMISTRI
            </div>

            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black font-sans text-text-primary dark:text-white tracking-tight">
              What is <span className="text-[#4400AF]">Pagemistri?</span>
            </h2>

            <div className="space-y-6 text-lg text-text-muted dark:text-slate-300 leading-relaxed">
              <p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <a
                ...
                className="bg-brand hover:bg-brand-hover text-white rounded-xl px-8 py-4 text-base font-bold shadow-md active:scale-95 transition-all group flex items-center justify-center"
              >
                Get Started
              ...
              <a
                href="#how-it-works"
                className="bg-white hover:bg-gray-50 text-text-primary border border-gray-200 hover:border-[#4400AF] dark:bg-slate-900 dark:hover:bg-slate-800 dark:text-white dark:border-slate-800 dark:hover:border-[#4400AF] rounded-xl px-8 py-4 text-base font-bold group flex items-center justify-center transition-all"
              >
                <PlayCircle className="w-5 h-5 mr-2 text-text-secondary dark:text-slate-400 group-hover:text-[#4400AF] transition-colors" />
                See How It Works
              </a>
            </div>
          </div>
