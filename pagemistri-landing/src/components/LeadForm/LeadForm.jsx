...
const LeadForm = () => {
  ...
  return (
    <div className="w-full font-sans">
      ...
      <div className="w-full relative flex items-center justify-center lg:justify-start">
        ...
        <div id="lead-form" className="bg-white dark:bg-slate-900 rounded-2xl p-6 sm:p-7 shadow-xl border border-slate-100 dark:border-slate-800 w-full max-w-md mx-auto lg:mx-0 relative z-10 transition-shadow overflow-hidden min-h-[500px]">
            ...
            {step === 1 ? (
              <>
                <div className="flex items-center gap-2.5">
                  <div className="h-3 w-3 rounded-full bg-purple-600 ring-4 ring-purple-100 dark:ring-purple-900/30" />
                  <div className="h-1 w-10 rounded-full bg-purple-100 dark:bg-purple-900/30" />
                </div>
