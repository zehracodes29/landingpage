...
const LeadForm = () => {
 ...
 <div>
 <label className="text-sm font-semibold text-[#52627A] dark:text-slate-400 mb-2 block">
 ...
 >
 <option className="bg-white dark:bg-slate-900 text-[#111827] dark:text-slate-100" value="" disabled>Select category</option>
 <option className="bg-white dark:bg-slate-900 text-[#111827] dark:text-slate-100" value="coach">Coach / Consultant</option>
 <option className="bg-white dark:bg-slate-900 text-[#111827] dark:text-slate-100" value="healthcare">Healthcare</option>
 <option className="bg-white dark:bg-slate-900 text-[#111827] dark:text-slate-100" value="real-estate">Real Estate</option>
 <option className="bg-white dark:bg-slate-900 text-[#111827] dark:text-slate-100" value="restaurant">Restaurant / Café</option>
 <option className="bg-white dark:bg-slate-900 text-[#111827] dark:text-slate-100" value="salon">Salon / Spa</option>
 <option className="bg-white dark:bg-slate-900 text-[#111827] dark:text-slate-100" value="education">Education</option>
 <option className="bg-white dark:bg-slate-900 text-[#111827] dark:text-slate-100" value="retail">Retail Store</option>
 <option className="bg-white dark:bg-slate-900 text-[#111827] dark:text-slate-100" value="other">Other</option>
 </select>
...
<label className={`cursor-pointer rounded-xl border py-3 text-center font-medium transition-all ${
 ...
 ? 'border-[#4400AF] bg-[rgba(68,0,175,0.05)] dark:bg-[rgba(68,0,175,0.08)] text-[#4400AF]  ring-1 ring-[#4400AF] shadow-sm dark:shadow-none'
 : 'border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900/80 text-[#6B7280] dark:text-slate-400 hover:border-purple-400 dark:hover:border-purple-500 hover:bg-slate-50 dark:hover:bg-slate-800/60 hover:shadow-sm dark:shadow-none'
 }`}>
 <input 
 type="radio" 
 name="hasWebsite" 
...
<label className={`cursor-pointer rounded-xl border py-3 text-center font-medium transition-all ${
 ...
 ? 'border-[#4400AF] bg-[rgba(68,0,175,0.05)] ring-1 ring-[#4400AF] shadow-sm dark:shadow-none' 
 ...
 />
 <span className={`text-sm font-medium ${formData.websiteGoals.includes(goal) ? 'text-[#4400AF]' : 'text-[#6B7280] dark:text-slate-400'}`}>{goal}</span>
 </label>
 ))}
 </div>
 ...
 className="w-full py-2.5 px-3.5 text-sm rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/90 text-[#111827] dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-[#52627A] focus:outline-none focus:ring-2 focus:ring-purple-500/20 dark:focus:ring-purple-500/20 focus:border-purple-500 dark:focus:border-purple-500 transition-all"
 />
 </div>
 )}
